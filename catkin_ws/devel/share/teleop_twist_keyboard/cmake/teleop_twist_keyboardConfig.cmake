...
if("TRUE" STREQUAL "TRUE")
  set(teleop_twist_keyboard_SOURCE_PREFIX /home/victor/labrom/catkin_ws/src/teleop_twist_keyboard)
  set(teleop_twist_keyboard_DEVEL_PREFIX /home/victor/labrom/catkin_ws/devel)
  ...
  set(teleop_twist_keyboard_INSTALL_PREFIX /home/victor/labrom/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'teleop_twist_keyboard' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'victor <victor@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'teleop_twist_keyboard' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/victor/labrom/catkin_ws/src/teleop_twist_keyboard/${idir}'.  Ask the maintainer 'victor <victor@todo.todo>' to fix it.")
    endif()
